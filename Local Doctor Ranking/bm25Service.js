 ...
 */
export const applyFilterConditions = (practitioners, filters) => {
 ...
 */
export const rankPractitionersBM25 = (documents, query, k1 = 1.5, b = 0.75, geocoded = null, semanticOptions = null) => {
 ...
 */
export const getTopNPractitioners = (rankedResults, n = 10) => {
 ...
 */
export const getBM25Shortlist = (practitioners, filters, shortlistSize = 10, geocoded = null, semanticOptions = null, options = {}) => {
 ...
 */
export const getBM25StageATopN = (practitioners, filters, n = 50, geocoded = null) => {
  const rc = getRankingConfig(filters);
 ...
 */
export const getEnhancedShortlist = (practitioners, filters, shortlistSize = 10) => {
 ...
 */
export const getBM25ShortlistWithSessionContext = async (
  practitioners,
  filters,
  shortlistSize = 10,
  geocoded = null,
 ...
 */
export const getProgressiveRankingV6 = async (practitioners, filters, sessionId, options = {}) => {
